     ...
     <div className="mt-[0.5cm] mb-[1cm] px-[1cm] flex justify-end">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center flex-1 text-center bg-[rgba(255,255,255,0.1)] backdrop-blur-md shadow-lg p-10 md:mx-[20%] mx-[5%] rounded-lg">
        ...
        <div className="mt-4 text-lg md:text-xl font-semibold text-gray-900 animate-fadeIn">
          Empowering the underbanked with trustless e-commerce
        </div>
        <p className="mt-4 text-lg text-white/90 max-w-2xl animate-fadeIn">
          VeryMarket is a decentralized on-chain marketplace built on Somnia's smart contract infrastructure, providing transparent and trustless trading. NFT-based receipts are stored on IPFS with immutable URIs recorded on-chain. This SDS-Enhanced edition introduces AI insights and real-time order tracking—powered by Somnia Data Streams—enabling instant buyer-seller updates, live marketplace analytics, and intelligent insights for pricing, demand forecasting, and seller performance.
        </p>
        <div className="my-8 flex gap-4 animate-slideUp">
          ...
          <Link href="https://github.com/mrpatrick030/SDS-Enhanced-VeryMarket/blob/main/README.md" target="_blank"><button
